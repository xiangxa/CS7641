...
def findBestPolicyForForest():
	...
	plt.title('Convergence of Error vs Iteration for Forest Mng State 1000', fontsize=12, y=1.03)
	plt.legend()
	plt.savefig('Figures/Forest/Error Convergence vs Iteration for Forest Mng state 1000.png')
	plt.close()
	...
	plt.xlabel('Iter.', fontsize=12)
	plt.title('Rewards vs Iteration for Forest Mng state 1000', fontsize=12, y=1.03)
	plt.legend()
	plt.savefig('Figures/Forest/Rewards vs Iteration for Forest Mng state 1000.png')
	plt.close()
	...
	plt.xlabel('Iter.', fontsize=12)
	plt.title('Time vs Iteration for Forest Mng state 1000', fontsize=12, y=1.03)
	plt.legend()
	plt.savefig('Figures/Forest/Time vs Iteration for Forest Mng  state 1000.png')
	plt.close()
...
def getPlotsForForestQl():
	...
	forest = ForestMng(states=1000, reward_wait=4, reward_cut=2)
	...
	plt.ylabel('Convergence', fontsize=12)
	plt.xlabel('Iter.', fontsize=12)
	plt.title('Error Convergence vs Iteration for Forest Mng State 1000', fontsize=12, y=1.03)
	plt.legend()
